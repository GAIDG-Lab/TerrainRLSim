...
void cSimCharacter::BuildSpherePart(int part_id, const tVector& root_pos, double friction,
								std::shared_ptr<cSimObj>& out_part)
{
	tMatrix com_world_trans = cKinTree::BodyWorldTrans(mJointMat, mBodyDefs, mPose, part_id);
	tVector pos = com_world_trans.col(3);
...
void cSimCharacter::BuildCylinderPart(int part_id, const tVector& root_pos, double friction,
								std::shared_ptr<cSimObj>& out_part)
{
	tMatrix com_world_trans = cKinTree::BodyWorldTrans(mJointMat, mBodyDefs, mPose, part_id);
	tVector pos = com_world_trans.col(3);
...
tVector cSimCharacter::GetCurrentGroundTarget() 
{
	return currentGroundTarget;
}

void cSimCharacter::SetCurrentGroundTarget(tVector newGroundTarget) 
{
