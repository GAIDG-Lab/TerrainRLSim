		...
		for (int j = 0; j < num_contacts; ++j)
		{
			...
			if (pt.getDistance() <= dist_tol)
			{
				...
				if(sim_obj0->mContactForce.mID == 0)
				{
					...
					sim_obj0->mContactForce.mCumForce += tVector(net_force[0], net_force[1], net_force[2], 0);
					sim_obj0->mContactForce.mNumForce += 1;
				}
				...
				if(sim_obj1->mContactForce.mID == 0)
				{
					...
					sim_obj1->mContactForce.mCumForce += tVector(net_force[0], net_force[1], net_force[2], 0);
					sim_obj1->mContactForce.mNumForce += 1;
				}
#endif
