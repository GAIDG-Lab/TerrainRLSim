...
public:
	...
	static void ParseRenderMode(const std::string& render_mode_str, eRenderMode& out_render_mode);
	...
	virtual std::unique_ptr<btCylinderShape> BuildCylinderShape(double radius, double height) const;
...
protected:
	...
	// virtual tConstraintHandle AddFixedConstraint(cSimObj* obj0, cSimObj* obj1, const tJointParams& params);
