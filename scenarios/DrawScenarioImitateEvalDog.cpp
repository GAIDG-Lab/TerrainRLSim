...
cDrawScenarioImitateEvalDog::cDrawScenarioImitateEvalDog(cCamera& cam)
...
cDrawScenarioImitateEvalDog::~cDrawScenarioImitateEvalDog()
{
}

void cDrawScenarioImitateEvalDog::Init()
{
	cDrawScenarioImitateTargetEval::Init();
}

void cDrawScenarioImitateEvalDog::BuildScene(std::shared_ptr<cScenarioSimChar>& out_scene) const
{
	out_scene = std::shared_ptr<cScenarioImitateStepEval>(new cScenarioImitateStepEval());
}

bool cDrawScenarioImitateEvalDog::EnableTargetPos() const
{
	auto step_scene = std::dynamic_pointer_cast<cScenarioExpImitateStep>(mScene);
	return step_scene->EnableTargetPos();
}

void cDrawScenarioImitateEvalDog::SetTargetPos(const tVector& pos)
{
...
void cDrawScenarioImitateEvalDog::ResetCallback()
{
...
void cDrawScenarioImitateEvalDog::DrawMisc() const
{
...
void cDrawScenarioImitateEvalDog::DrawStepPlan() const
{
...
void cDrawScenarioImitateEvalDog::DrawStepPos(const tVector& pos, const tVector& col) const
{
...
void cDrawScenarioImitateEvalDog::DrawRootHeading(const cBipedStepController3D::tStepPlan& step_plan, const tVector& col) const
{
...
void cDrawScenarioImitateEvalDog::ToggleDrawStepPlan()
{
	drawStepPlan = !drawStepPlan;
}

void cDrawScenarioImitateEvalDog::Keyboard(unsigned char key, int x, int y)
{
...
tVector cDrawScenarioImitateEvalDog::GetCamTrackPos() const
{
...
std::string cDrawScenarioImitateEvalDog::BuildTextInfoStr() const
{
...
void cDrawScenarioImitateEvalDog::AdjustHackLerp(double delta)
{
	const auto& character = mScene->GetCharacter();
	const auto& ctrl = character->GetController();
	auto step_ctrl = std::dynamic_pointer_cast<cBipedStepController3D>(ctrl);
...
void cDrawScenarioImitateEvalDog::HackRecordActionPerturb()
{
...
void cDrawScenarioImitateEvalDog::HackAdjustCtrlPeriod(double delta)
{
	auto ctrl = std::dynamic_pointer_cast<cCtPhaseController>(mScene->GetCharacter()->GetController());
	if (ctrl != nullptr)
	{
