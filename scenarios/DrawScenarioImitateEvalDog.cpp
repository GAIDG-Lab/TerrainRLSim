#include "DrawScenarioImitateEvalDog.h"
...
void cDrawScenarioImitateEvalDog::Reset()
{
...
void cDrawScenarioImitateEvalDog::DrawCharacters() const
{
...
void cDrawScenarioImitateEvalDog::DrawKinChar() const
{
...
const std::shared_ptr<cKinCharacter>& cDrawScenarioImitateEvalDog::GetKinChar() const
{
	auto scene = std::dynamic_pointer_cast<cScenarioImitateEval>(mScene);
	return scene->GetKinChar();
}

void cDrawScenarioImitateEvalDog::ToggleDrawKinChar()
{
...
tVector cDrawScenarioImitateEvalDog::GetDrawKinCharOffset() const
{
	/*
	const auto& kin_char = GetKinChar();
