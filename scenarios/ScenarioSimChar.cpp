...
cScenarioSimChar::cScenarioSimChar()
{
	...
	mWorldParams.mRenderMode = cWorld::eRenderMode2D;
...
void cScenarioSimChar::ParseArgs(const std::shared_ptr<cArgParser>& parser)
{
	...
	parser->ParseString("render_mode", render_mode_str);
	cWorld::ParseRenderMode(render_mode_str, mWorldParams.mRenderMode);
	...
	{
		mCtrlParams.mNetFiles[cTerrainRLCtrlFactory::eNetFileActor] = fpath + mCtrlParams.mNetFiles[cTerrainRLCtrlFactory::eNetFileActor];
		mCtrlParams.mNetFiles[cTerrainRLCtrlFactory::eNetFileCritic] = fpath + mCtrlParams.mNetFiles[cTerrainRLCtrlFactory::eNetFileCritic];
		mCtrlParams.mNetFiles[cTerrainRLCtrlFactory::eNetFileActor1] = fpath + mCtrlParams.mNetFiles[cTerrainRLCtrlFactory::eNetFileActor1];
		mCtrlParams.mNetFiles[cTerrainRLCtrlFactory::eNetFileCritic1] = fpath + mCtrlParams.mNetFiles[cTerrainRLCtrlFactory::eNetFileCritic1];
		// mCtrlParams.mNetFiles[cTerrainRLCtrlFactory::eNetFileActorSolver] = fpath + mCtrlParams.mNetFiles[cTerrainRLCtrlFactory::eNetFileActorSolver];
		// mCtrlParams.mNetFiles[cTerrainRLCtrlFactory::eNetFileCriticSolver] = fpath + mCtrlParams.mNetFiles[cTerrainRLCtrlFactory::eNetFileCriticSolver];
		// mCtrlParams.mNetFiles[cTerrainRLCtrlFactory::eNetFileActor1Solver] = fpath + mCtrlParams.mNetFiles[cTerrainRLCtrlFactory::eNetFileActor1Solver];
		// mCtrlParams.mNetFiles[cTerrainRLCtrlFactory::eNetFileCritic1Solver] = fpath + mCtrlParams.mNetFiles[cTerrainRLCtrlFactory::eNetFileCritic1Solver];
		// mCtrlParams.mNetFiles[cTerrainRLCtrlFactory::eNetFileActorModel] = fpath + mCtrlParams.mNetFiles[cTerrainRLCtrlFactory::eNetFileActorModel];
		// mCtrlParams.mNetFiles[cTerrainRLCtrlFactory::eNetFileCriticModel] = fpath + mCtrlParams.mNetFiles[cTerrainRLCtrlFactory::eNetFileCriticModel];
		// mCtrlParams.mNetFiles[cTerrainRLCtrlFactory::eNetFileActor1Model] = fpath + mCtrlParams.mNetFiles[cTerrainRLCtrlFactory::eNetFileActor1Model];
		// mCtrlParams.mNetFiles[cTerrainRLCtrlFactory::eNetFileCritic1Model] = fpath + mCtrlParams.mNetFiles[cTerrainRLCtrlFactory::eNetFileCritic1Model];

		// mCtrlParams.mNetFiles[cTerrainRLCtrlFactory::eNetFileActorTerrainModel] = fpath + mCtrlParams.mNetFiles[cTerrainRLCtrlFactory::eNetFileActorTerrainModel];
		// mCtrlParams.mNetFiles[cTerrainRLCtrlFactory::eNetFileActorActionModel] = fpath + mCtrlParams.mNetFiles[cTerrainRLCtrlFactory::eNetFileActorActionModel];
		// mCtrlParams.mNetFiles[cTerrainRLCtrlFactory::eNetFileCriticTerrainModel] = fpath + mCtrlParams.mNetFiles[cTerrainRLCtrlFactory::eNetFileCriticTerrainModel];
		// mCtrlParams.mNetFiles[cTerrainRLCtrlFactory::eNetFileCriticValueModel] = fpath + mCtrlParams.mNetFiles[cTerrainRLCtrlFactory::eNetFileCriticValueModel];

		// mCtrlParams.mNetFiles[cTerrainRLCtrlFactory::eNetFileForwardDynamics] = fpath + mCtrlParams.mNetFiles[cTerrainRLCtrlFactory::eNetFileForwardDynamics];
		// mCtrlParams.mNetFiles[cTerrainRLCtrlFactory::eNetFileForwardDynamicsSolver] = fpath + mCtrlParams.mNetFiles[cTerrainRLCtrlFactory::eNetFileForwardDynamicsSolver];
		// mCtrlParams.mNetFiles[cTerrainRLCtrlFactory::eNetFileForwardDynamicsModel] = fpath + mCtrlParams.mNetFiles[cTerrainRLCtrlFactory::eNetFileForwardDynamicsModel];
...
bool cScenarioSimChar::EnabledRecording() const
{
	return mRecordMotion;
}
...
cWorld::eRenderMode cScenarioSimChar::GetRenderMode() const
{
	return mWorldParams.mRenderMode;
}
