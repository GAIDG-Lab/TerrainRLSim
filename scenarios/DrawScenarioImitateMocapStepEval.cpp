...
cDrawScenarioImitateMocapStepEval::~cDrawScenarioImitateMocapStepEval()
{
}
...
void cDrawScenarioImitateMocapStepEval::DrawStepPlan() const
{
...
void cDrawScenarioImitateMocapStepEval::DrawStepPos(const tVector& pos, const tVector& col) const
{
...
void cDrawScenarioImitateMocapStepEval::DrawRootHeading(const cBipedStepController3D::tStepPlan& step_plan, const tVector& col) const
{
...
void cDrawScenarioImitateMocapStepEval::ToggleDrawStepPlan()
{
...
tVector cDrawScenarioImitateMocapStepEval::GetCamTrackPos() const
{
...
void cDrawScenarioImitateMocapStepEval::AdjustHackLerp(double delta)
{
	const auto& character = mScene->GetCharacter();
	const auto& ctrl = character->GetController();
	auto step_ctrl = std::dynamic_pointer_cast<cBipedStepController3D>(ctrl);
...
void cDrawScenarioImitateMocapStepEval::HackRecordActionPerturb()
{
...
void cDrawScenarioImitateMocapStepEval::HackAdjustCtrlPeriod(double delta)
{
	auto ctrl = std::dynamic_pointer_cast<cCtPhaseController>(mScene->GetCharacter()->GetController());
	if (ctrl != nullptr)
	{
