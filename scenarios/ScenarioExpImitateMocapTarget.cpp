#include "ScenarioExpImitateMocapTarget.h"
...
double cScenarioExpImitateMocapTarget::CalcTargetReward(const tVector& tar_pos) const
{
	double pose_w = 0.5;
	double vel_w = 0.05;
...
cScenarioExpImitateMocapTarget::cScenarioExpImitateMocapTarget()
{
...
void cScenarioExpImitateMocapTarget::ParseArgs(const std::shared_ptr<cArgParser>& parser)
{
	cScenarioExpImitateMocap::ParseArgs(parser);
...
void cScenarioExpImitateMocapTarget::Init()
{
	cScenarioExpImitateMocap::Init();
	ResetTargetPos();
}

void cScenarioExpImitateMocapTarget::Reset()
{
	cScenarioExpImitateMocap::Reset();
	ResetTargetPos();
}

void cScenarioExpImitateMocapTarget::Update(double time_elapsed)
{
	cScenarioExpImitateMocap::Update(time_elapsed);
	UpdateTargetPos(time_elapsed);
}

const tVector& cScenarioExpImitateMocapTarget::GetTargetPos() const
{
	return mTargetPos;
}

void cScenarioExpImitateMocapTarget::SetTargetPos(const tVector& target_pos)
{
...
void cScenarioExpImitateMocapTarget::EnableRandTargetPos(bool enable)
{
	mEnableRandTargetPos = enable;
}

bool cScenarioExpImitateMocapTarget::EnabledRandTargetPos() const
{
	return mEnableRandTargetPos;
}

double cScenarioExpImitateMocapTarget::GetTargetResetDist() const
{
	return mTargetResetDist;
}

std::string cScenarioExpImitateMocapTarget::GetName() const
{
	return "Imitate Target Exploration";
}


bool cScenarioExpImitateMocapTarget::CheckResetTarget() const
{
...
void cScenarioExpImitateMocapTarget::InitCharacterPos(const std::shared_ptr<cSimCharacter>& out_char)
{
...
void cScenarioExpImitateMocapTarget::SetCharRandPlacement(const std::shared_ptr<cSimCharacter>& out_char)
{
...
void cScenarioExpImitateMocapTarget::CalcCharRandPlacement(tVector& out_pos, tQuaternion& out_rot)
{
...
void cScenarioExpImitateMocapTarget::CalcCharRandPlacementTrail3D(tVector& out_pos, tQuaternion& out_rot)
{
...
void cScenarioExpImitateMocapTarget::CalcCharRandPlacementObstacles3D(tVector& out_pos, tQuaternion& out_rot)
{
...
void cScenarioExpImitateMocapTarget::CalcCharRandPlacementDynamicObstacles3D(tVector& out_pos, tQuaternion& out_rot)
{
...
void cScenarioExpImitateMocapTarget::CalcCharRandPlacementDefault(tVector& out_pos, tQuaternion& out_rot)
{
...
double cScenarioExpImitateMocapTarget::CalcReward() const
{
	return CalcTargetReward(mTargetPos);
}

void cScenarioExpImitateMocapTarget::UpdateTargetController()
{
...
void cScenarioExpImitateMocapTarget::UpdateTargetPos(double time_elapsed)
{
...
double cScenarioExpImitateMocapTarget::GetRandTargetMaxDist() const
{
	return gMaxTargetDist;
}

void cScenarioExpImitateMocapTarget::ResetTargetPos()
{
...
tVector cScenarioExpImitateMocapTarget::CalcTargetPosTrail3D()
{
...
tVector cScenarioExpImitateMocapTarget::CalcTargetPosObstacle3D()
{
	auto obstacles = std::dynamic_pointer_cast<cGroundObstacles3D>(mGround);
...
tVector cScenarioExpImitateMocapTarget::CalcTargetPosDynamicObstacle3D()
{
...
tVector cScenarioExpImitateMocapTarget::CalcTargetPosDefault()
{
...
int cScenarioExpImitateMocapTarget::GetTargetPosTrail3dForwardSegs() const
{
	//return 10;
	return 1;
}
