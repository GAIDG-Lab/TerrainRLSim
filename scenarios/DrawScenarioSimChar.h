...
protected:
	...
	virtual void DrawGroundReactionForces() const;
	virtual void DrawPolicyPlots() const;
	virtual bool HasMuscules(const std::shared_ptr<cSimCharacter>& character) const;
	virtual void DrawCharMuscles(const std::shared_ptr<cSimCharacter>& character) const;
	virtual void DrawGroundDynamicObstacles3D(const std::shared_ptr<cGround>& ground) const;
	virtual void DrawGroundObstacles3D(const std::shared_ptr<cGround>& ground) const;
