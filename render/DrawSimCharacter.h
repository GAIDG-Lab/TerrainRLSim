...
public:
	...
	static void DrawGroundReactionForces(const cSimCharacter &character, const cGround &ground, double marker_size, double vel_scale,
										 const tVector &pos_col, const tVector &vel_col, const tVector &offset);
	...
	static void DrawLinearVelocity(const cSimCharacter &character, const tVector &offset); // Ray
	static void DrawTotalForce(const cSimCharacter &character, const tVector &offset);
	static void DrawNetForce(const cSimCharacter &character, const tVector &offset);

	static void DrawmForces(const cSimCharacter &character, const tVector &offset);
	static void DrawForces(const cSimCharacter &character, const tVector &offset);

	static void DrawAngularVelocity(const cSimCharacter &character, const tVector &offset);
	static void DrawVelocity(const cSimCharacter &character, const tVector &offset);
	static void DrawImpulse(const cSimCharacter &character, const tVector &offset);
	static void DrawNetLinearVelocity(const cSimCharacter &character, const tVector &offset);
	static void DrawGRFs(const cSimCharacter &character, const cGround &ground, double marker_size, double vel_scale,
						 const tVector &pos_col, const tVector &vel_col, const tVector &offset);
