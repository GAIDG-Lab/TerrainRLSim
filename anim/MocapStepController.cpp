...
cMocapStepController::cMocapStepController() 
{
	...
	mLeftHandID = gInvalidIdx;
	mRightHandID = gInvalidIdx;
...
void cMocapStepController::SetHandJoints(int right_end_id, int left_end_id)
{
	mRightHandID = right_end_id;
	mLeftHandID = left_end_id;
}
...
void cMocapStepController::SetupMirrorStanceJoints()
{
	...
	curr_right = mRightHandID;
	curr_left = mLeftHandID;
...
void cMocapStepController::setRelativeFilePath(std::string path)
{
